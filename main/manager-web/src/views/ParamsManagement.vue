    ...
    <div class="welcome">
        ...
        <div class="operation-bar">
            ...
            <div class="right-operations">
                <el-input placeholder="Enter parameter code or remark to search" v-model="searchCode" class="search-input"
                        ...
                        <div class="table_bottom">
                            ...
                            <div class="custom-pagination">
                                <el-select v-model="pageSize" @change="handlePageSizeChange" class="page-size-select">
                                    <el-option v-for="item in pageSizeOptions" :key="item" :label="`${item} per page`"
                                        :value="item">
                                    </el-option>
                                </el-select>
...
export default {
    ...
    methods: {
        ...
        deleteParam(row) {
            ...
            this.$confirm(`Are you sure you want to delete the selected ${paramCount} parameters?`, 'Warning', {
                ...
                Api.admin.deleteParam(ids, ({ data }) => {
                    if (data.code === 0) {
                        this.$message.success({
                            message: `Successfully deleted ${paramCount} parameters`,
                            showClose: true
                        });
                        this.fetchParams();
                    } else {
