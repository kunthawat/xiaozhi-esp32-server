...
export default {
  ...
  methods: {
    ...
    // Update agent list with search results
    ...
    handleDeleteAgent(agentId) {
      this.$confirm('Are you sure you want to delete this agent?', 'Warning', {
        ...
        Api.agent.deleteAgent(agentId, (res) => {
          if (res.data.code === 0) {
            ...
            this.$message.error({
              message: res.data.msg || 'Delete failed',
              showClose: true
            });
          }
        });
