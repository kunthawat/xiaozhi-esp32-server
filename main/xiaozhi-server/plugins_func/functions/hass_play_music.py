    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                "media_content_id": {
                    "type": "string",
                    "description": "Can be album name, song name, or artist of music or audiobook, fill 'random' if not specified",
                },
                "entity_id": {
                    "type": "string",
                    "description": "Device ID of the speaker to operate, entity_id in Home Assistant, starts with media_player",
                },
            },
...
def hass_play_music(conn, entity_id="", media_content_id="random"):
    try:
        ...
        return ActionResponse(
            action=Action.RESPONSE, result="Music intent processed", response=ha_response
        )
